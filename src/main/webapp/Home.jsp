	...
	<div id="form">
		<form name="homeForm" id="homeformId" method="post" action="Home">
			...
			<div class="splash-container">
				<h1 class="splash-head is-center">Mental Health in the Era of
					COVID 19</h1>
			</div>
			<div class="content-wrapper">
				<div class="content">
					...
					%>
					<div id="errormessage">
						<font color=red size=3px><%=message%></font>
					</div>
					<%
						}
					%>
					...
					<div class="row h-100 justify-content-center align-items-center">
						<label for="search">Enter UserId to search:</label> <input
							type='text' name="search" id="searchId"
							style="width: 400px; height: 40px;" class="form-control" /> <input
							type="hidden" name="hiddenField" id="hiddenField" />
					</div>
					<br />
					<div>
						<button type="submit" class="btn btn-primary" name="searchUser"
							id="searchUserId" onclick="checkIfUserExists();">Search</button>
					</div>
					<br />
					<div>
						<button type="submit" class="btn btn-primary" name="createUser"
							id="createUserId" value="createUser">Create New User</button>
					</div>
				</div>
			</div>
